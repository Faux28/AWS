...
class S3LambdaTriggerStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        iam_role = iam.Role(self, "s3-trigger-lambda",
        ...
        # iam_role.add_managed_policy(iam.ManagedPolicy.from_aws_managed_policy_name("AmazonS3FullAccess"))
        ...
        s3 = _s3.Bucket(self, "ffi-lambda-trigger")
